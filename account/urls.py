...
PasswordResetVerifyView, PasswordResetFinishView, UserAddressCreateView, UserAddressUpdateView
...
urlpatterns = [
    ...
    path('address/', UserAddressCreateView.as_view(), name='addresses'),
    path('address/<int:id>', UserAddressUpdateView.as_view(), name='address-update'),
]
